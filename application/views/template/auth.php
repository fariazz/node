...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Naevette Portal | Sign In</title>
	...
	<body id="login">
		...
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
				...
				<h1>Naevette Portal</h1>
				<!-- Logo (221px width) -->
				<img id="logo" src="<?php echo base_url(); ?>www/img/logo.png" alt="Naevette Portal" />
			</div> <!-- End #logn-top -->
			...
			<div id="login-content">
					...
					<p>
						...
						<input class="text-input" name="login" type="text" />
					</p>
					<div class="clear"></div>
					<p>
