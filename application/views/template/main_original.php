...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="<?php echo base_url(); ?>www/img/logo.png" alt="Simpla Admin logo" /></a>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="#" title="Edit"><img src="<?php echo base_url(); ?>www/img/icons/pencil.png" alt="Edit" /></a>
										 <a href="#" title="Delete"><img src="<?php echo base_url(); ?>www/img/icons/cross.png" alt="Delete" /></a> 
